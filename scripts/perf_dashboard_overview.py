...
async def run(*, base_url: str, requests: int, concurrency: int) -> None:
    url = base_url.rstrip("/") + "/api/dashboard/overview?requestLimit=25&requestOffset=0"
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Basic latency sampling for GET /api/dashboard/overview.")
